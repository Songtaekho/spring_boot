...
public class PageVO {
    ...
    public PageVO(Criteria cri, int total) {
        ...
        //끝페이지 끝 번호 계산
        //현재 조회하는 페이지가 11번 - > 끝페이지 20번
        //현재 조회하는 페이지가 5번 - > 끝페이지 번호 10번
        //(int)(Math.ceil( 현재조회하는번호/ 페이지네이션개수)) * 페이지네이션 개수
        ...
        //실제 끝번호 계산
        //데이터가 53개라면 -> 실제마지막페이지번호 6
        //데이터가 165개라면 -> 실제마지막페이지번호 17
        //(int)Math.ceil(총 게시글 수 / 현재 조회하는 데이터 개수)
