...
//    }
    ...
    public String updateForm(ProductVO vo) {
        ...
        return "redirect:/product/productDetail?prodId=" + vo.getProdId(); //수정하고 컨텐츠 화면으로
    }
    ...
    */
    ...
    public String deleteForm(ProductVO vo
        ...
        if(result == 1) {
            ...
            ra.addFlashAttribute("msg", "시스템 문제로 인해 삭제에 실패했습니다\n1577-1000으로 문의주세요");
        }

        return "redirect:/product/productList?prodId=" + vo.getProdId();
    }
